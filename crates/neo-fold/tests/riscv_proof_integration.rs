...
use neo_memory::riscv_lookups::{
    ...
    RiscvMemOp, RiscvMemory, RiscvOpcode, RiscvShoutTables,
};
...
fn riscv_exec_simple_arithmetic() {
    ...
    let program = vec![
        RiscvInstruction::IAlu { op: RiscvOpcode::Add, rd: 1, rs1: 0, imm: 2 },
        RiscvInstruction::IAlu { op: RiscvOpcode::Add, rd: 2, rs1: 0, imm: 3 },
        RiscvInstruction::RAlu { op: RiscvOpcode::Add, rd: 3, rs1: 1, rs2: 2 },
        RiscvInstruction::IAlu { op: RiscvOpcode::Add, rd: 4, rs1: 3, imm: 5 },
...
fn riscv_exec_memory_program() {
    ...
    let program = vec![
        ...
        // x3 = 20
        RiscvInstruction::IAlu { op: RiscvOpcode::Add, rd: 3, rs1: 0, imm: 20 },
        // mem[x1] = x2 (store 10)
...
fn riscv_exec_multiplication_program() {
    ...
    let program = vec![
        ...
        // x4 = x3 / x1 = 13
        RiscvInstruction::RAlu { op: RiscvOpcode::Divu, rd: 4, rs1: 3, rs2: 1 },
        // x5 = x3 % x1 = 0
        RiscvInstruction::RAlu { op: RiscvOpcode::Remu, rd: 5, rs1: 3, rs2: 1 },
        RiscvInstruction::Halt,
    ];
